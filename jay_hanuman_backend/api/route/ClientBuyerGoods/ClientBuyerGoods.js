...
const {
  addClientBuyerGoods,
  deleteClientBuyerGoods,
  getClientBuyerGoods,
  updateClientBuyerGoods,
} = require("../../controller/ClientBuyerGoods/ClientBuyerGoods");
...
router
  ...
  .post(
    ...
    validate(ClientBuyerGoodValidation.ClientBuyerGoodsSchema),
    addClientBuyerGoods
  );
router
