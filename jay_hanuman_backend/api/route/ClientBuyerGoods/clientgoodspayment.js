...
const {
  createClientPayment,
  updateClientGoodsPayment,
  getClientGoodsPayment,
  deleteClientGoodsPayment,
} = require("../../controller/ClientBuyerGoods/clientgoodspayment");
...
router
  ...
  .post(
    ...
    validate(clientGoodsPaymentValidation.clientGoodsPaymentSchema),
    createClientPayment
  );
router
...
router
  ...
  .put(
    verifyToken,
    authorizeRole("Admin"),
    validate(ClientGoodPaymentValidation.clientGoodsPaymentSchema),
    updateClientGoodsPayment
  );
