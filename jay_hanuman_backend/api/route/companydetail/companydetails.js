...
const {
  ...
  deleteCompany,
  getCompanyById,
} = require("../../controller/companydetail/companydetails");
...
router
  ...
  .post(
    ...
    validate(CompanyValidation.companyDetailsValidation),
    addCompany
  );
...
router.route("/:id").delete(verifyToken, authorizeRole("Admin"), deleteCompany);
