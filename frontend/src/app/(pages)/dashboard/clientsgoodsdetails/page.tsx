 ...
 const handleClickYear = (year: number) => {
    ...
    return <div className="p-6 bg-orange-50 min-h-screen ">
        <div  className="grid grid-cols-3 items-center mb-6">
            ...
            <h1 className="text-3xl mb-3 text-center font-bold text-orange-600 underline underline-offset-8">Client Goods Managemnt</h1>
        </div>
        ...
        <ClientGoodsDetailsYearlyComp currentYear={currentYearAdd}/>
    </div>;
}